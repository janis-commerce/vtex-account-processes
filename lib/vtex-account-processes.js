...
const ValidateAccountProcess = require('./helpers/validate');
...
module.exports = class VtexAccountProcesses {
	...
	async send(accountId, processName, newStatus, content, options) {
		...
		ValidateAccountProcess.validateParams(this.session, accountId, processName, newStatus, content, options);
